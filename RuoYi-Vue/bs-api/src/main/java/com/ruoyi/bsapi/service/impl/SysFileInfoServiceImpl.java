...
import com.ruoyi.bsapi.mapper.SysFileInfoMapper;
...
public class SysFileInfoServiceImpl implements ISysFileInfoService 
{
    ...
    @Override
    public void deleteSkuInfoByPrimaryKey(String uploadProductSkuPicId) {
        sysFileInfoMapper.deleteSkuInfoByPrimaryKey(uploadProductSkuPicId);
    }
}
