...
public class SysFileInfoController extends BaseController
{
     ...
     * 查询文件信息列表
     */
    @PreAuthorize("@ss.hasPermi('bsapi:info:list')")
    @GetMapping("/list")
     ...
     * 导出文件信息列表
     */
    @PreAuthorize("@ss.hasPermi('bsapi:info:export')")
     ...
     * 获取文件信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('bsapi:info:query')")
     ...
     * 新增文件信息
     */
    @PreAuthorize("@ss.hasPermi('bsapi:info:add')")
     ...
     * 修改文件信息
     */
    @PreAuthorize("@ss.hasPermi('bsapi:info:edit')")
     ...
     * 删除文件信息
     */
    @PreAuthorize("@ss.hasPermi('bsapi:info:remove')")
